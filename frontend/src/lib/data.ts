export const PROJECTS = [
  ...
  },
  {
    ...
    statusColor: 'blue' as const,
    featured: true,
    link: 'https://huggingface.co/spaces/Oduwo/DrugD_clinical_AI',
    github: null,
  },
  {
    id: 'llm-finetuning',
...
export const PUBLIC_PROFILES = [
  {
    ...
    url: 'https://www.linkedin.com/in/emmanuel-bain-240284382',
    icon: 'linkedin',
    color: '#0A66C2',
  },
  {
    ...
    url: 'https://github.com/Emmanuel-Bain-Oduwo',
    icon: 'github',
    color: '#333333',
  },
  {
    ...
    url: 'https://huggingface.co/Oduwo',
    icon: 'huggingface',
    color: '#FFD21E',
  },
  {
    ...
    url: 'https://www.kaggle.com/bainnn',
    icon: 'kaggle',
    color: '#20BEFF',
  },
  {
    ...
    url: 'https://orcid.org/0009-0008-9430-9311',
    icon: 'orcid',
    color: '#A6CE39',
  },
  {
    ...
    url: 'https://www.researchgate.net/profile/Emmanuel-Bain-Oduwo',
    icon: 'researchgate',
    color: '#00CCBB',
  },
  {
    ...
    url: 'https://paruluniversity.academia.edu/EMMANUELBAINODUWO',
    icon: 'academia',
    color: '#41454A',
  },
  {
    ...
    url: 'https://devpost.com/bainemmanuel86',
    icon: 'devpost',
    color: '#003E54',
  },
  {
  ...
  },
  {
    ...
    url: 'https://youtube.com/@emmanuel_bain_oduwo',
    icon: 'youtube',
    color: '#FF0000',
  },
]
