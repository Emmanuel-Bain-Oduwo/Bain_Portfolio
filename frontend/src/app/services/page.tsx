          ...
          <Up>
            ...
            <div className="space-y-4">
              {[
                ...
                { Icon: Mail, text: 'Email: emmanuelbain@kemirix.com' },
                { Icon: Send, text: 'WhatsApp: +254 707 862 452' },
              ].map(({ Icon, text }) => (
            ...
            <Up>
              ...
              >
                ...
                <div className="flex flex-wrap gap-3 flex-shrink-0">
                  ...
                  <a href="https://wa.me/254707862452" target="_blank" rel="noopener noreferrer" className="btn-outline whitespace-nowrap">
